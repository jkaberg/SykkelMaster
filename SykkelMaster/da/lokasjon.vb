Public Class lokasjonDAO
    ...
    Public Shared Function leggTilLokasjon(ByVal lokasjon As lokasjon) As Boolean
    ...
    Public Shared Function oppdaterLokasjon(ByVal lokasjon As lokasjon) As Boolean
    ...
    Public Shared Function fjernLokasjon(ByVal lokasjon As lokasjon) As Boolean
